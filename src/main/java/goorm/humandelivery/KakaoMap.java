...
public class KakaoMap {
    ...
    public static Location convertAddressToLocation(String address) {
        try {
            ...
            System.out.println("URI 구문 오류 발생: " + e.getMessage());
            e.printStackTrace();
        } catch (InterruptedException e) {
            System.out.println("HTTP 요청 중단: " + e.getMessage());
    ...
    // 위도, 경도를 주소로 변환하는 메서드
    public static String convertCoordinatesToAddress(double latitude, double longitude) {
        try {
            // 좌표를 URL 인코딩하여 요청
